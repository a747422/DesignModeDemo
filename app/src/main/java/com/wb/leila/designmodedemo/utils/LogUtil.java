 ...
 * @author Leila
 * @version V1.0
 * @date 2018/4/11 17:45
 * className  LogUtil
 * email leila329@163.com
 * description  日志封装 https://blog.csdn.net/q919233914/article/details/52046667
 */
public class LogUtil {
    ...
    /**
     * 通过增加属性isShowLog及LOG_LEVEL对我们的log进行控制，方便在发布Release包的时候快速关闭日志输出
     *
     * @param isShowLog
     */
    ...
    /**
     * 循环获取Stack Trace Element中的element,分析获取到具体的调用类方法及对应行数
     *
     * @return
     */
